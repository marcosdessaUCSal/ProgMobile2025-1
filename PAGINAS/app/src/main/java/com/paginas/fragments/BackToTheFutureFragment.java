...
public class BackToTheFutureFragment extends Fragment {

    public BackToTheFutureFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_back_to_the_future, container, false);
    }
    ...
    private void mostrarSnackbar(View view) {
        // Criando um snackbar
        Snackbar sb =  Snackbar.make(view, "Obrigado por clicar em De Volta Para o Futuro!", Snackbar.LENGTH_SHORT);
